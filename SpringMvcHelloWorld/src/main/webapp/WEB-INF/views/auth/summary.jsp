                    ...
                    <div class="summary-grid">
                        <div class="summary-item">
                            ...
                            <div class="summary-content">
                                ...
                                <span class="summary-value">${param.fullName != null ? param.fullName : sessionScope.registeredUser.fullName}</span>
                            </div>
                        </div>
                        ...
                        <div class="summary-item">
                            ...
                            <div class="summary-content">
                                ...
                                <span class="summary-value">${param.email != null ? param.email : sessionScope.registeredUser.email}</span>
                            </div>
                        </div>
                        ...
                        <div class="summary-item">
                            ...
                            <div class="summary-content">
                                ...
                                <span class="summary-value">${param.phone != null ? param.phone : sessionScope.registeredUser.phone}</span>
                            </div>
                        </div>
                        ...
                        <div class="summary-item">
                            <div class="summary-icon">
                                <c:choose>
                                    <c:when test="${param.userType == 'owner' || sessionScope.registeredUser.userType == 'VENUE_OWNER'}">🏟️</c:when>
                            ...
                            <div class="summary-content">
                                ...
                                <span class="summary-value">
                                    <c:choose>
                                        <c:when test="${param.userType == 'owner' || sessionScope.registeredUser.userType == 'VENUE_OWNER'}">
                                            Venue Owner
                                        </c:when>
                                        <c:otherwise>
                                            Player
